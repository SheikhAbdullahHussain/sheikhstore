...
export function Logo({ compact = false }: { compact?: boolean }) {
  return (
    <Link to="/" className="group flex items-center gap-2.5" aria-label="SheikhStore home">
      <span className="relative grid size-12 place-items-center rounded-xl bg-ink text-primary-foreground shadow-sm">
        ...
        <img src="/Sheikh_logo.png" alt="logo" className="size-10" aria-hidden="true"/>
      </span>
